...
public class Strings {
    ...
    public final static String NO_USER = PLUGIN_SECONDARY_COLOR + "Du bist kein Spieler";
    public final static String NO_PERM = PLUGIN_SECONDARY_COLOR + "Du hast darauf keine Rechte";

    public static final String LEFT_GAME = PLUGIN_SECONDARY_COLOR + "Spiel verlassen";
    public static final String JOIN_GAME = PLUGIN_SECONDARY_COLOR + "Spiel betreten";
